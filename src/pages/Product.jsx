    ...
    <div className="max-w-7xl mx-auto p-6 flex flex-col gap-8">
      ...
      <div className="flex gap-4 flex-col sm:gap-8 sm:flex-row">
        ...
        <div className="flex flex-col gap-4 w-fit sm:w-1/3">
          <img src={image} alt={productData.name} className="w-full h-96 object-cover rounded-lg" />
        ...
        <div className="w-2/3">
          ...
          <p className="text-xl font-semibold mt-2">{currency} {productData.price}</p>
            ...
            <div className="flex gap-2 mt-2 mb-2">
              {productData.sizes.map((item, index) => (
                <button 
                  ...
                  key={index} 
                  className={`border-[1px] border-black/20 px-4 py-2 rounded-sm ${size === item ? "bg-black text-white" : ""}`}
                >
                  {item}
                </button>
              ))}
          ...
          {/* Add to Cart Button */}
          <button className="mt-6 bg-black text-white px-6 py-3 rounded-sm hover:bg-gray-800">
            Add to Cart
          </button>
      ...
      <div className="mt-10">
        <div className="flex border-b pb-2">
          <button className="px-6 py-2 text-md font-semibold">Description</button>
          <button className="px-6 py-2 text-md font-semibold">Reviews (122)</button>
        </div>
        <div className="mt-4">
      ...
      <div className='mt-10'>
           <RelatedProduct currentProductId= {productData._id} category={productData.category} />
      </div>
